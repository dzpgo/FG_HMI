    ...
    public class CranePLCStatusInBay
    {
        ...
        public void SetReady()
        {
            try
            {
                ...
                foreach (string theCranNO in lstCraneNO)
                {
                    ...
                    //36
                    lstAdress.Add(tag_Head + CranePLCStatusBase.ADRESS_CRANE_COIL_TEMPERATURE);
        ...
        private CranePLCStatusBase getCranePLCStatusFromTags(string theCraneNO)
        {
            ...
            try
            {
                ...
                //36
                cranePLCBase.COIL_TEMPERATURE = get_value_x(tag_Head + CranePLCStatusBase.ADRESS_CRANE_COIL_TEMPERATURE);
