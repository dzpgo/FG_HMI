...
{
    public partial class PREMIERE_TESTING_Z61_BAY : FormBase
    {
        public PREMIERE_TESTING_Z61_BAY()
        {
            InitializeComponent();
        }
        ...
        private long baySpaceX = 232000;
        private long baySpaceY = 48000;
        private int panelWidth;
        private int panelHeight;
        private bool xAxisRight = true;
        private bool yAxisDown = false;
        private string bayNO = "Z61";

        private string craneNO_1 = "1_4";
        private string craneNO_2 = "1_5";
        private string craneNO_3 = "1_6";
        ...
        private void PREMIERE_TESTING_4_3_TO_4_5_Load(object sender, EventArgs e)
        {
            try
            {
