...
namespace CONTROLS_OF_PREMIERE
{
    public partial class PopCraneComputerOrderSetting : Form
    {
        ...
        private long autoMode = 0;
        public long AutoMode
        {
            get { return autoMode; }
            set { autoMode = value; }
        }
        ...
        private void cmdCreateComputerOrder_Click(object sender, EventArgs e)
        {
            try
            {
                if(autoMode != 4)
                {
                    ...
                    string strWmsSql = " Update WMS_CRANE_ORDER set ";

                    strWmsSql += " BAY_NO=" + "'" + bayNO + "'" + ",";

                    strWmsSql += " MAT_NO=" + "'" + matNO + "'" + ",";

                    strWmsSql += " FROM_STOCK_NO=" + "'" + fromStockNO + "'" + ",";

                    strWmsSql += " TO_STOCK_NO=" + "'" + toStockNO + "'" + ",";

                    strWmsSql += " PLAN_UP_X=" + planUpX + ",";

                    strWmsSql += " PLAN_UP_Y=" + planUpY + ",";

                    strWmsSql += " PLAN_UP_Z=" + planUpZ + ",";

                    strWmsSql += " UP_ROTATE_ANGLE_SET=" + upRotateAngleSet + ",";

                    strWmsSql += " CLAMP_WIDTH_SET=" + clampWidthSet + ",";

                    strWmsSql += " PLAN_DOWN_X=" + planDownX + ",";

                    strWmsSql += " PLAN_DOWN_Y=" + planDownY + ",";

                    strWmsSql += " PLAN_DOWN_Z=" + planDownZ + ",";

                    strWmsSql += " DOWN_ROTATE_ANGLESET=" + downRotateAngleSet + ",";

                    strWmsSql += " COIL_WIDTH=" + coilWidth + ",";

                    strWmsSql += " COIL_WEIGHT=" + coilWeight + ",";

                    strWmsSql += " COIL_OUT_DIA=" + coilOutDia + ",";

                    strWmsSql += " COIL_IN_DIA=" + coilInDia + ",";

                    strWmsSql += " FLOOR_UP_Z=" + floorUpZ + ",";

                    strWmsSql += " FLAG_SMALL_COIL=" + flagSmallCoil + ",";

                    strWmsSql += " FLOOR_DOWN_Z=" + floorDownZ + ",";

                    strWmsSql += " CMD_STATUS=" + "'" + "INIT" + "'";

                    strWmsSql += " where ORDER_NO=" + "'" + orderID + "'";

                    DBHelper.ExecuteNonQuery(strWmsSql);
            ...
            try
            {
                if (autoMode != 4)
                {
                    ...
                    if (hasCoil == 1)
                    {
                        ...
                        strSql += " CMD_STATUS=" + "'" + "COIL_DOWN_PROCESS" + "'";
        ...
        private void cmdClearDataItems_Click(object sender, EventArgs e)
        {
            try
            {
                if (autoMode != 4)
                {
                    ...
                    string strWmsSql = " DELETE FROM WMS_CRANE_ORDER ";
