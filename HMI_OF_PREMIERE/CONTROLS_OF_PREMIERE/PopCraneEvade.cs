    ...
    public partial class PopCraneEvade : Form
    {
        ...
        void PopCraneEvadeLoad(object sender, EventArgs e)
        {
            if (Crane_NO != null)
            {
                ...
                if (crane_NO == "4_1" || crane_NO == "4_2")
                {
                    tagRequestName = "Z62_EVADE_REQUEST";
                    tagCancelName = "Z62_EVADE_CANCEL";
                }
                else if (crane_NO == "4_5" || crane_NO == "4_4" || crane_NO == "4_3")
                {
                    tagRequestName = "Z63_EVADE_REQUEST";
                    tagCancelName = "Z63_EVADE_CANCEL";
                }
                else if (crane_NO == "1_5" || crane_NO == "1_4" || crane_NO == "1_6")
                {
                    tagRequestName = "Z61_EVADE_REQUEST";
                    tagCancelName = "Z61_EVADE_CANCEL";
                }
                else if (crane_NO == "1_1" || crane_NO == "1_2" || crane_NO == "1_3")
                {
                    tagRequestName = "Z73_EVADE_REQUEST";
                    tagCancelName = "Z73_EVADE_CANCEL";
                }
