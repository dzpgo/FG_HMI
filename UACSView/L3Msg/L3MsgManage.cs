...
namespace UACSView
{
    public partial class L3MsgManage : FormBase
    {
        ...
        public L3MsgManage()
        {
            ...
            DBHelper2 = Baosight.iSuperframe.Common.DataBase.DBFactory.GetHelper("ZJDB0");//平台连接数据库的Text
        }
        ...
        private void buttonRecvQuery_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                sqlStr = String.Format("{0} where CLOCK > '{1}{2}' and CLOCK < '{3}{4}' and msgid like 'KDEM%' ",
                    sqlStr,
