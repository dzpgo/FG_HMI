...
{
    public partial class RedStockInquiry : FormBase
    {
        public RedStockInquiry()
        {
            InitializeComponent();
        }
        ...
        private void btnInquiry_Click(object sender, EventArgs e)
        {
            ...
            string rectime1 = dateTimePicker1.Value.ToString("yyyyMMdd") + "000000";
            string rectime2 = dateTimePicker2.Value.ToString("yyyyMMdd") + "000000";                       
            string sqlText = @"SELECT STOCK_NO,BAY_NO,LAST_CHANGE_TIME FROM UACS_YARDMAP_STOCK_DEFINE  WHERE LOCK_FLAG = '1' AND BAY_NO = '" + Area_NO + "' AND LAST_CHANGE_TIME >= '" + rectime1 + "' AND LAST_CHANGE_TIME <= '" + rectime2 + "' AND STOCK_TYPE = 0 ORDER BY LAST_CHANGE_TIME";           
