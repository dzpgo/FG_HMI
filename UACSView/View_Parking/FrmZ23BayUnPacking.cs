...
namespace UACSView
{
    public partial class FrmZ23BayUnPacking : FormBase
    {
        public FrmZ23BayUnPacking()
        {
            InitializeComponent();
            SetStyle(ControlStyles.AllPaintingInWmPaint
                | ControlStyles.OptimizedDoubleBuffer
                | ControlStyles.UserPaint, true);
            this.Load += FrmZ23BayUnPacking_Load;
        }
        #region  -----------------------------连接数据库--------------------------------
        ...
        void FrmZ23BayUnPacking_Load(object sender, EventArgs e)
        {

            dicSaddleControls["D174PC0001"] = Z23BayUnParkingArea_1;
            Z23BayUnParkingArea_1.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z23BayUnParkingArea_1).Key;
            dicSaddleControls["D174PC0002"] = Z23BayUnParkingArea_2;
            Z23BayUnParkingArea_2.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z23BayUnParkingArea_2).Key;
            dicSaddleControls["D174PC0003"] = Z23BayUnParkingArea_3;
            Z23BayUnParkingArea_3.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z23BayUnParkingArea_3).Key;

            dicControl[Z23BayUnParkingArea_1] = conOffLinePackingSaddleInfo1;
            dicControl[Z23BayUnParkingArea_2] = conOffLinePackingSaddleInfo2;
            dicControl[Z23BayUnParkingArea_3] = conOffLinePackingSaddleInfo3;       
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //{
                    ...
                    offineSaddle.ReadDefintion("Z23-PC");
                ...
                if (pressed)
                {
                    entrySaddleInfo.getPlanByUnitNo(dataGridView1, constData.UnitNo_7);
                ...
                if(press)
                {
                    offineSaddle.GetOffLinePackingByZ34034Info(dgvOffLineSaddleInfo, "D174PC");
        ...
        private void btnResetLight_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.OK)
            {
                inDatas["D174PC_LIGHT_CURTAIN_RESET"] = 1;
                tagDataProvider.Write2Level1(inDatas, 1);
                ParkClassLibrary.HMILogger.WriteLog(btnResetLight.Text, "Z23拆包" + btnResetLight.Text, ParkClassLibrary.LogLevel.Info, "Z23跨拆包画面");
            }
            timer2.Enabled = true;
        }
        ...
        {
            inDatas["D174PC_LIGHT_CURTAIN_RESET"] = 0;
            tagDataProvider.Write2Level1(inDatas, 1);
        ...
        public void SetReady()
        {
            try
            {
                ...
                lstAdress.Add("D174PC_LIGHT_CURTAIN_RESET");
