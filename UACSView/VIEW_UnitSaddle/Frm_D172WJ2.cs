...
namespace UACSView
{
    public partial class Frm_D172WJ2 : FormBase
    {
        public Frm_D172WJ2()
        {
            InitializeComponent();
        ...
        private void refreshControl()
        {
            try
            {
                ...
                {
                    if (theAreaInfo.AreaNo.Contains("D172-WJ2"))
                    {
        ...
        private void Frm_D172WJ2_TabActivated(object sender, EventArgs e)
        {
            timer2.Enabled = true;
        }

        private void Frm_D172WJ2_TabDeactivated(object sender, EventArgs e)
        {
