...
namespace UACSView
{
    public partial class FrmZ73BayOffLinePacking : FormBase
    {
        public FrmZ73BayOffLinePacking()
        {
            InitializeComponent();
        ...
        #region  -----------------------------方法字段--------------------------------
        private const string BayNo = "Z73";
        ...
        private const string D373UnitNo = "D373";
        private const string D374UnitNo = "D374";
        bool pressed = true;
        bool press = true;
        ...
        void FrmZ21BayOffLinePacking_Load(object sender, EventArgs e)
        {
            ...
            dicSaddleControls["Z73PR10003"] = Z73BayParkingArea_3;
            Z73BayParkingArea_3.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z73BayParkingArea_3).Key;
            dicSaddleControls["Z73PR10002"] = Z73BayParkingArea_2;
            Z73BayParkingArea_2.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z73BayParkingArea_2).Key;
            dicSaddleControls["Z73PR10001"] = Z73BayParkingArea_1;
            Z73BayParkingArea_1.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z73BayParkingArea_1).Key;
            dicSaddleControls["Z73PR10005"] = Z73BayParkingArea_5;
            Z73BayParkingArea_5.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z73BayParkingArea_5).Key;
            dicSaddleControls["Z73PR10004"] = Z73BayParkingArea_4;
            Z73BayParkingArea_4.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z73BayParkingArea_4).Key;
            dicSaddleControls["Z73PR10008"] = Z73BayParkingArea_8;
            Z73BayParkingArea_8.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z73BayParkingArea_8).Key;
            dicSaddleControls["Z73PR10007"] = Z73BayParkingArea_7;
            Z73BayParkingArea_7.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z73BayParkingArea_7).Key;
            dicSaddleControls["Z73PR10006"] = Z73BayParkingArea_6;
            Z73BayParkingArea_6.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z73BayParkingArea_6).Key;
            dicSaddleControls["Z73PR10010"] = Z73BayParkingArea_10;
            Z73BayParkingArea_10.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z73BayParkingArea_10).Key;
            dicSaddleControls["Z73PR10009"] = Z73BayParkingArea_9;
            Z73BayParkingArea_9.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z73BayParkingArea_9).Key;
           

            dicControl[Z73BayParkingArea_3] = conOffLinePackingSaddleInfo3;
            dicControl[Z73BayParkingArea_2] = conOffLinePackingSaddleInfo2;
            dicControl[Z73BayParkingArea_1] = conOffLinePackingSaddleInfo1;
            dicControl[Z73BayParkingArea_5] = conOffLinePackingSaddleInfo5;
            dicControl[Z73BayParkingArea_4] = conOffLinePackingSaddleInfo4;
            dicControl[Z73BayParkingArea_8] = conOffLinePackingSaddleInfo8;
            dicControl[Z73BayParkingArea_10] = conOffLinePackingSaddleInfo10;
            dicControl[Z73BayParkingArea_7] = conOffLinePackingSaddleInfo7;
            dicControl[Z73BayParkingArea_6] = conOffLinePackingSaddleInfo6;
            dicControl[Z73BayParkingArea_9] = conOffLinePackingSaddleInfo9;

            //-----------------------行车状态---------------------------------
            conCraneStatus1_1.InitTagDataProvide(constData.tagServiceName);
            conCraneStatus1_1.CraneNO = "1_1";
            ...
            craneStatusInBay.AddCraneNO("1_1");
            craneStatusInBay.AddCraneNO("1_2");
            craneStatusInBay.AddCraneNO("1_3");
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //string s = string.Format("{0}{1}",tmp,i == 0? "1":"2");    
                    ...
                    offineSaddle.ReadDefintion("Z73-PR");
                ...
                if (pressed)
                {                   
                    offineSaddle.GetOffLinePackingByUnitSaddleInfo(D373UnitNo, BayNo, dataGridView1);
                    ChangeDGVColorByPackCode(dataGridView1);

                    offineSaddle.GetOffLinePackingByUnitSaddleInfo(D374UnitNo, BayNo, dataGridView2);
                    ChangeDGVColorByPackCode(dataGridView2);
                }

                if(press)
                {
                    offineSaddle.GetOffLinePackingByZ34034Info(dgvOffLineSaddleInfo, "Z73PR");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string sql1 = @"UPDATE UACS_OFFLINE_PACKING_AREA_STOCK_DEFINE SET CONFIRM_FLAG = 30 WHERE STOCK_NO IN (SELECT STOCK_NO FROM UACS_YARDMAP_STOCK_DEFINE WHERE MAT_NO != 'NULL' AND STOCK_STATUS = 2 AND LOCK_FLAG = 0 AND STOCK_NO IN (SELECT STOCK_NO FROM UACS_OFFLINE_PACKING_AREA_STOCK_DEFINE WHERE SUB_AREA_ID = 'Z73-PR1'))";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string sql2 = @"UPDATE UACS_OFFLINE_PACKING_AREA_STOCK_DEFINE SET CONFIRM_FLAG = 30 WHERE STOCK_NO IN (SELECT STOCK_NO FROM UACS_YARDMAP_STOCK_DEFINE WHERE MAT_NO != 'NULL' AND STOCK_STATUS = 2 AND LOCK_FLAG = 0 AND STOCK_NO IN (SELECT STOCK_NO FROM UACS_OFFLINE_PACKING_AREA_STOCK_DEFINE WHERE SUB_AREA_ID = 'Z73-PR2'))";
