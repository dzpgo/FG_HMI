...
namespace UACSView
{
    public partial class LianTui_Pack_Exit : FormBase
    {
        ...
        public LianTui_Pack_Exit()
        {
            ...
            this.Load += LianTui_Pack_Exit_Load;
        }
        ...
        void LianTui_Pack_Exit_Load(object sender, EventArgs e)
        {
            auth = FrameContext.Instance.GetPlugin<IAuthorization>() as IAuthorization;
            tagDataProvider.ServiceName = "iplature";
            //绑定鞍座控件                     
            dicSaddleControls["PA-1WC0001"] = coilUnitSaddle1;
            dicSaddleControls["PA-1WC0002"] = coilUnitSaddle2;
            dicSaddleControls["PA-1WC0003"] = coilUnitSaddle3;
            dicSaddleControls["PA-1WC0004"] = coilUnitSaddle4;
            dicSaddleControls["PA-1WC0005"] = coilUnitSaddle5;
            dicSaddleControls["PA-1WC0006"] = coilUnitSaddle6;
            dicSaddleControls["PA-1WC0007"] = coilUnitSaddle7;
            dicSaddleControls["PA-1WC0008"] = coilUnitSaddle8;
            dicSaddleControls["PA-1WC0009"] = coilUnitSaddle9;
            dicSaddleControls["PA-1WC0010"] = coilUnitSaddle10;
            dicSaddleControls["PA-1WC0011"] = coilUnitSaddle11;
            dicSaddleControls["PA-1WC0012"] = coilUnitSaddle12;
            dicSaddleControls["PA-1WC0013"] = coilUnitSaddle13;
            dicSaddleControls["PA-1WC0014"] = coilUnitSaddle14;
            dicSaddleControls["PA-1WC0015"] = coilUnitSaddle15;
            dicSaddleControls["PA-1WC0016"] = coilUnitSaddle16;
            ...
            //实例化机组鞍座处理类
            saddleMethod = new UnitSaddleMethod(constData.UnitNo_9,constData.ExitSaddleDefine,constData.tagServiceName);
            saddleMethod.ReadDefintion();
            
            lineSaddleTag.InitTagDataProvider(constData.tagServiceName);

            coilUnitSaddleButton.MySaddleNo = "PA-1WC0001";                            
            ...
            Get_PA_Status();
            exitSaddleInfo.getExitSaddleDt(dgvExitSaddleInfo,constData.UnitNo_9);
            dgvRefresh();
            //是否开启定时器
        ...
        private void dgvExitSaddleInfo_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dgvExitSaddleInfo.Columns[e.ColumnIndex].Name == "FORBIDEN_COIL_FLOW")
            {
                ...
                if (((DataGridViewButtonCell)dgvExitSaddleInfo.Rows[e.RowIndex].Cells["FORBIDEN_COIL_FLOW"]).UseColumnTextForButtonValue == true)
                {
                    ...
                    frmForbidenCoilFlow.UnitNo = constData.UnitNo_9;
