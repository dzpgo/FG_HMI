...
namespace UACSView
{
    public partial class VIEW_D408ExitLineSaddle : FormBase
    {
        private Baosight.iSuperframe.Authorization.Interface.IAuthorization auth;
        public VIEW_D408ExitLineSaddle()
        {
            InitializeComponent();
            //反射获取双缓存
        ...
        private const string AREA_SAFE_EXIT_D408 = "AREA_SAFE_D408_EXIT";
        ...
        void VIEW_D108ExitLineSaddle_Load(object sender, EventArgs e)
        {
            ...
            dicSaddleControls["D408WC0008"] = coilUnitSaddle8;
            dicSaddleControls["D408WC0007"] = coilUnitSaddle7;
            dicSaddleControls["D408WC0006"] = coilUnitSaddle6;
            dicSaddleControls["D408WC0005"] = coilUnitSaddle5;
            dicSaddleControls["D408WC0004"] = coilUnitSaddle4;
            dicSaddleControls["D408WC0003"] = coilUnitSaddle3;
            dicSaddleControls["D408WC0002"] = coilUnitSaddle2;
            dicSaddleControls["D408WC0001"] = coilUnitSaddle1;

            //coilUnitStatus1.InitTagDataProvide(constData.tagServiceName);
            //coilUnitStatus1.MyStatusTagName = AREA_SAFE_EXIT_D102;

            //实例化机组鞍座处理类
            saddleMethod = new UnitSaddleMethod(constData.UnitNo_D408, constData.ExitSaddleDefine,constData.tagServiceName);
            saddleMethod.ReadDefintion();
            
            lineSaddleTag.InitTagDataProvider(constData.tagServiceName);

            coilUnitSaddleButton.MySaddleNo = "D408WC0008";                                 
            ...
            exitSaddleInfo.getExitSaddleDt(dgvExitSaddleInfo,constData.UnitNo_D408);
            dgvRefresh();
            //是否开启定时器
        ...
        private void dgvExitSaddleInfo_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dgvExitSaddleInfo.Columns[e.ColumnIndex].Name == "FORBIDEN_COIL_FLOW")
            {
                ...
                if (((DataGridViewButtonCell)dgvExitSaddleInfo.Rows[e.RowIndex].Cells["FORBIDEN_COIL_FLOW"]).UseColumnTextForButtonValue == true)
                {
                    ...
                    frmForbidenCoilFlow.UnitNo = constData.UnitNo_D408;
