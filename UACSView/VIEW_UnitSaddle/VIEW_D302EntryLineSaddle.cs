...
namespace UACSView
{
    public partial class VIEW_D302EntryLineSaddle : FormBase
    {
        private Baosight.iSuperframe.Authorization.Interface.IAuthorization auth;

        #region -----------------------load加载----------------------------------

        public VIEW_D302EntryLineSaddle()
        {
            ...
            this.Load += VIEW_D171EntryLineSaddle_Load;
        ...
        private const string AREA_SAFE_D302_ENTRY = "AREA_SAFE_D302_WR";
        ...
        void VIEW_D171EntryLineSaddle_Load(object sender, EventArgs e)
        {
            auth = FrameContext.Instance.GetPlugin<IAuthorization>() as IAuthorization;
            #region 绑定鞍座控件
            dicSaddleControls["D302WR0001"] = coilUnitSaddle1;
            dicSaddleControls["D302WR0002"] = coilUnitSaddle2;
            dicSaddleControls["D302WR0003"] = coilUnitSaddle3;
            dicSaddleControls["D302WR0004"] = coilUnitSaddle4;
            dicSaddleControls["D302WR0005"] = coilUnitSaddle5;
            dicSaddleControls["D302WR0006"] = coilUnitSaddle6;
            dicSaddleControls["D302WR0007"] = coilUnitSaddle7;
            dicSaddleControls["D302WR0008"] = coilUnitSaddle8;
            dicSaddleControls["D302WR0009"] = coilUnitSaddle9;
            dicSaddleControls["D302WR0010"] = coilUnitSaddle10;
            //dicSaddleControls["D108WR1A06"] = coilUnitSaddle6;
            #endregion

            //实例化机组鞍座处理类
            saddleMethod = new UnitSaddleMethod(constData.UnitNo_D302, constData.EntrySaddleDefine, constData.tagServiceName);
            saddleMethod.ReadDefintion();

            coilUnitStatus1.InitTagDataProvide(constData.tagServiceName);
            coilUnitStatus1.MyStatusTagName = AREA_SAFE_D302_ENTRY;
            ...
            coilUnitSaddleButton1.MySaddleNo = "D302WR0001";
            coilUnitSaddleButton2.MySaddleNo = "D302WR0002";
            coilUnitSaddleButton3.MySaddleNo = "D302WR0003";
            coilUnitSaddleButton4.MySaddleNo = "D302WR0004";
            coilUnitSaddleButton5.MySaddleNo = "D302WR0005";
            coilUnitSaddleButton6.MySaddleNo = "D302WR0006";
            coilUnitSaddleButton7.MySaddleNo = "D302WR0007";
            coilUnitSaddleButton8.MySaddleNo = "D302WR0008";
            coilUnitSaddleButton9.MySaddleNo = "D302WR0009";
            coilUnitSaddleButton10.MySaddleNo = "D302WR0010";
            ...
            //craneStatusInBay.AddCraneNO("4_5");
            //craneStatusInBay.SetReady();

            conEntrySpecAction1.UnitNo = constData.UnitNo_D302;
            conEntrySpecAction1.BayNo = "Z61";
            ...
            entrySaddleInfo.getEntrySaddleDt(dataGridViewSaddleMessage, constData.UnitNo_D302);
            CoilPlan();
            //是否开启定时器
            timer1.Enabled = true;
            //设定刷新时间
        ...
        private void CoilPlan()
        {
            ...
            entrySaddleInfo.getL2PlanByUnitNo(dataGridViewPlanNum, constData.UnitNo_D302);
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                coilEntryMode1.UnitNO = constData.UnitNo_D302;
        ...
        private void timer3_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                saddleMethod.GetCoilLabel(constData.UnitNo_D302, lblNextCoil, label2);
        ...
        public static void ClearMemory()
        {
            ...
            {
                VIEW_D302EntryLineSaddle.SetProcessWorkingSetSize(System.Diagnostics.Process.GetCurrentProcess().Handle, -1, -1);
            }
        }
        #endregion
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            unitRotate.UintNo = constData.UnitNo_D302;
        ...
        private void btnExecuteNonQuery(int MANU_VALUE, DataGridView dgv)
        {
            try
            {
                ...
                if(MANU_VALUE == 1)
                {
                    HMILogger.WriteLog("带头旋转", "D302机组入口,钢卷" + strCoil + "设置为旋转180°", LogLevel.Info, this.Text);
                }
                else if (MANU_VALUE == 0)
                {
                    HMILogger.WriteLog("带头旋转", "D302机组入口,钢卷" + strCoil + "设置为不旋转", LogLevel.Info, this.Text);
                }
            }
            catch (Exception ex)
            {
