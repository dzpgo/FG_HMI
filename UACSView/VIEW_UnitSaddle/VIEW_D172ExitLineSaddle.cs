...
namespace UACSView
{
    public partial class VIEW_D172ExitLineSaddle : FormBase
    {
        private Baosight.iSuperframe.Authorization.Interface.IAuthorization auth;
        public VIEW_D172ExitLineSaddle()
        {
            InitializeComponent();
            //反射获取双缓存
            ...
            this.Load += VIEW_D172ExitLineSaddle_Load;
        }
        ...
        void VIEW_D172ExitLineSaddle_Load(object sender, EventArgs e)
        {
            auth = FrameContext.Instance.GetPlugin<IAuthorization>() as IAuthorization;
            tagDataProvider.ServiceName = "iplature";
            //绑定鞍座控件                     
            dicSaddleControls["D172WC0006"] = coilUnitSaddle6;
            dicSaddleControls["D172WC0005"] = coilUnitSaddle5;
            dicSaddleControls["D172WC0004"] = coilUnitSaddle4;

            //coilUnitStatus1.InitTagDataProvide(constData.tagServiceName);
            //coilUnitStatus1.MyStatusTagName = AREA_SAFE_EXIT_D102;

            //实例化机组鞍座处理类
            saddleMethod = new UnitSaddleMethod(constData.UnitNo_5,constData.ExitSaddleDefine,constData.tagServiceName);
            saddleMethod.ReadDefintion();
            
            lineSaddleTag.InitTagDataProvider(constData.tagServiceName);

            coilUnitSaddleButton4.MySaddleNo = "D172WC0004";
            coilUnitSaddleButton5.MySaddleNo = "D172WC0005";
            coilUnitSaddleButton6.MySaddleNo = "D172WC0006";        
        ...
        private void btn_Coil_Down_Click(object sender, EventArgs e)
        {
            ...
            string Unit_NO = constData.UnitNo_5;
