...
namespace UACSView
{
    public partial class VIEW_D508EntryLineSaddle : FormBase
    {
        ...
        public VIEW_D508EntryLineSaddle()
        {
        ...
        private const string AREA_SAFE_D508_ENTRY = "AREA_SAFE_D508_WR";
        ...
        void VIEW_D174EntryLineSaddle_Load(object sender, EventArgs e)
        {
            ...
            dicSaddleControls["D508WR0003"] = coilUnitSaddle2;
            dicSaddleControls["D508WR0002"] = coilUnitSaddle3;
            dicSaddleControls["D508WR0001"] = coilUnitSaddle4;
            ...
            coilUnitStatus1.MyStatusTagName = AREA_SAFE_D508_ENTRY;
            ...
            coilUnitSaddleButton1.MySaddleNo = "D508WR0001";
            coilUnitSaddleButton2.MySaddleNo = "D508WR0002";
            coilUnitSaddleButton3.MySaddleNo = "D508WR0003";
            ...
            conEntrySpecAction1.UnitNo = constData.UnitNo_D508;
            conEntrySpecAction1.BayNo = "Z62";
            ...
            entrySaddleInfo.getEntrySaddleDt(dataGridViewSaddleMessage, constData.UnitNo_D508);
            CoilPlan();
            //dgvColor();
            //是否开启定时器
            timer1.Enabled = true;
        ...
        {
            entrySaddleInfo.getL2PlanByUnitNo(dataGridViewPlanNum, constData.UnitNo_D508);
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                coilEntryMode1.UnitNO = constData.UnitNo_D508;
        ...
        private void timer3_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                saddleMethod.GetCoilLabel(constData.UnitNo_D508, lblNextCoil, label2);
