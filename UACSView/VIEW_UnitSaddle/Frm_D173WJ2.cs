...
namespace UACSView
{
    public partial class Frm_D173WJ2 : FormBase
    {
        public Frm_D173WJ2()
        {
            InitializeComponent();
        ...
        private void refreshControl()
        {
            try
            {
                ...
                {
                    if (theAreaInfo.AreaNo.Contains("D173-WJ2"))
                    {
        ...
        private void Frm_D174WJ2_TabActivated(object sender, EventArgs e)
        {
            timer2.Enabled = true;
        }

        private void Frm_D174WJ2_TabDeactivated(object sender, EventArgs e)
        {
