...
namespace UACSView
{
    public partial class VIEW_D374ExitLineSaddle : FormBase
    {
        private Baosight.iSuperframe.Authorization.Interface.IAuthorization auth;
        public VIEW_D374ExitLineSaddle()
        {
            InitializeComponent();
            //反射获取双缓存
            ...
            this.Load += VIEW_D171ExitLineSaddle_Load;
        }
        ...
        private const string AREA_SAFE_EXIT_D374 = "AREA_SAFE_D374_EXIT";
        ...
        void VIEW_D171ExitLineSaddle_Load(object sender, EventArgs e)
        {
            auth = FrameContext.Instance.GetPlugin<IAuthorization>() as IAuthorization;
            tagDataProvider.ServiceName = "iplature";
            //绑定鞍座控件                     
            dicSaddleControls["D374WC0006"] = coilUnitSaddle6;
            dicSaddleControls["D374WC0005"] = coilUnitSaddle5;
            dicSaddleControls["D374WC0004"] = coilUnitSaddle4;

            //coilUnitStatus1.InitTagDataProvide(constData.tagServiceName);
            //coilUnitStatus1.MyStatusTagName = AREA_SAFE_EXIT_D102;

            //实例化机组鞍座处理类
            saddleMethod = new UnitSaddleMethod(constData.UnitNo_D374, constData.ExitSaddleDefine,constData.tagServiceName);
            saddleMethod.ReadDefintion();
            
            lineSaddleTag.InitTagDataProvider(constData.tagServiceName);

            coilUnitSaddleButton4.MySaddleNo = "D374WC0004";
            coilUnitSaddleButton5.MySaddleNo = "D374WC0005";
            coilUnitSaddleButton6.MySaddleNo = "D374WC0006";        
            ...
            exitSaddleInfo.getExitSaddleDt(dgvExitSaddleInfo,constData.UnitNo_D374);
        ...
        private void btn_Coil_Down_Click(object sender, EventArgs e)
        {
            ...
            string Unit_NO = constData.UnitNo_D374;
