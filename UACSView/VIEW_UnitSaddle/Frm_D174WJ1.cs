...
namespace UACSView
{
    public partial class Frm_D174WJ1 : FormBase
    {
        public Frm_D174WJ1()
        {
            InitializeComponent();
        ...
        private void refreshControl()
        {
            try
            {
                ...
                {
                    if (theAreaInfo.AreaNo.Contains("D174-WJ1"))
                    {
        ...
        private void Frm_D174WJ1_TabActivated(object sender, EventArgs e)
        {
            timer2.Enabled = true;
        }

        private void Frm_D174WJ1_TabDeactivated(object sender, EventArgs e)
        {
