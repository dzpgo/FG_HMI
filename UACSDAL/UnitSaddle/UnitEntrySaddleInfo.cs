    ...
    public class UnitEntrySaddleInfo
    {
        ...
        public void getL2PlanByUnitNo(DataGridView _dgv, string _unit_no)
        {
            ...
            try
            {
                ...
                //                end ) MANU_VALUE,
                string sqlText = null;             
                sqlText = @"SELECT A.PLAN_SEQ PLAN_SEQ , A.COIL_NO COIL_NO, A.WEIGHT WEIGHT,A.WIDTH WIDTH,A.IN_DIA IN_DIA,A.OUT_DIA OUT_DIA, A.PACK_FLAG PACK_FLAG, B.CONFIRM_FLAG CONFIRM_FLAG,
                               (CASE A.STATUS
                                WHEN 100 THEN '库内' 
                                WHEN 200 THEN '起吊' 
                                WHEN 300 THEN '机组鞍座'
