...
namespace GDITest
{
    public partial class frmView_Vertical_II : Form
    {
        public frmView_Vertical_II()
        {
            InitializeComponent();
        }
        ...
        private void cmdDisplay_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Bitmap localBitmap = new Bitmap(Convert.ToInt32(intCarLength) + 200, Convert.ToInt32(intCarWidth) + 200);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                Bitmap originalBitmap = new Bitmap("d:\\Display.bmp");

                Bitmap disBitmap=new Bitmap(originalBitmap,new Size(Convert.ToInt32(originalBitmap.Width*1.1),Convert.ToInt32(originalBitmap.Height*1.1)));

                originalBitmap.Dispose();

                disBitmap.Save("d:\\Display.bmp");
                pictureBox.Load("d:\\Display.bmp");
        ...
        {
            if (e.X > 0 && e.Y > 0 && e.X < pictureBox.Width && e.Y < pictureBox.Height)
            {
                conLine_Y.Width = 2;
                conLine_Y.Top = 0;
                conLine_Y.Height = pictureBox.Height;
