...
namespace UACSView.VIEW_UnitSaddle
{
    ...
    /// 查询已经分配了的吊运指令
    /// </summary>
    public partial class Frm_D112CoilPlan : FormBase
    {
        ...
        private void RefleshPlanOrder()
        {
            ...
            {
                string sqlSelhalfnextcoil = string.Format(@"UPDATE UACS_LINE_NEXTCOIL SET NEXT_COILNO = '' WHERE UNIT_NO = 'D112_Z22'");
            ...
            else
            {
                for (int i = 0; i < dataGridView2.Rows.Count; i++)
                {
                    ...
                    if (i == 0)
                    {
                        string sqlSelhalfnextcoil = string.Format(@"UPDATE UACS_LINE_NEXTCOIL SET NEXT_COILNO = '{0}' WHERE UNIT_NO = 'D112_Z22'", coil_NO);
                        DBHelper.ExecuteNonQuery(sqlSelhalfnextcoil);
                    }
                }
            }
