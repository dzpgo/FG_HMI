...
namespace CONTROLS_OF_PREMIERE
{
    public partial class ConCraneStatusPanel : UserControl
    {
        ...
        public delegate void RefreshControlInvoke(CranePLCStatusBase theCranePLCStatusBase, string theBayNo);
        //step3
        public void RefreshControl(CranePLCStatusBase theCranePLCStatusBase,string theBayNo)
        {
            try
            {
                bayNo = theBayNo;
                ...
                autoMode = cranePLCStatusBase.ControlMode;
                ...
                hasCoil = cranePLCStatusBase.HasCoil;
        ...
        private void cmdComputerOrder_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //}
                        ...
                        popCraneComputerOrderSetting.HasCoil = hasCoil;
                        popCraneComputerOrderSetting.AutoMode = autoMode;
        ...
        {
            string theBayNo = bayNo;
            PopStockToStock form = new PopStockToStock(theBayNo);
        ...
        private void cmdDownLoadPlan_Click_1(object sender, EventArgs e)
        {
