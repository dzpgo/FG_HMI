...
namespace UACSView
{
    public partial class VIEW_D208ExitLineSaddle : FormBase
    {
        private Baosight.iSuperframe.Authorization.Interface.IAuthorization auth;
        public VIEW_D208ExitLineSaddle()
        {
            InitializeComponent();
            //反射获取双缓存
            ...
            this.Load += VIEW_D208ExitLineSaddle_Load;
        }
        ...
        void VIEW_D208ExitLineSaddle_Load(object sender, EventArgs e)
        {
            auth = FrameContext.Instance.GetPlugin<IAuthorization>() as IAuthorization;
            tagDataProvider.ServiceName = "iplature";
            //绑定鞍座控件
            //dicSaddleControls["D102WC1A08"] = coilUnitSaddle19;
            //dicSaddleControls["D102WC1A09"] = coilUnitSaddle12;
            dicSaddleControls["D208WC0008"] = coilUnitSaddle8;
            dicSaddleControls["D208WC0007"] = coilUnitSaddle7;
            dicSaddleControls["D208WC0006"] = coilUnitSaddle6;
            dicSaddleControls["D208WC0005"] = coilUnitSaddle5;
            dicSaddleControls["D208WC0004"] = coilUnitSaddle4;
            dicSaddleControls["D208WC0003"] = coilUnitSaddle3;

            //coilUnitStatus1.InitTagDataProvide(constData.tagServiceName);
            //coilUnitStatus1.MyStatusTagName = AREA_SAFE_EXIT_D102;

            //实例化机组鞍座处理类
            saddleMethod = new UnitSaddleMethod(constData.UnitNo_4,constData.ExitSaddleDefine,constData.tagServiceName);
            saddleMethod.ReadDefintion();
            
            lineSaddleTag.InitTagDataProvider(constData.tagServiceName);

            coilUnitSaddleButton3.MySaddleNo = "D208WC0003";
            coilUnitSaddleButton4.MySaddleNo = "D208WC0004";
            coilUnitSaddleButton5.MySaddleNo = "D208WC0005";
            coilUnitSaddleButton6.MySaddleNo = "D208WC0006";
            coilUnitSaddleButton7.MySaddleNo = "D208WC0007";
            coilUnitSaddleButton8.MySaddleNo = "D208WC0008";         
            ...
            GetLightCoilFlag();
            exitSaddleInfo.getExitSaddleDt(dgvExitSaddleInfo,constData.UnitNo_4);
            //是否开启定时器
        ...
        private void GetLightCoilFlag()
        {
            List<string> lstAdress = new List<string>();
            lstAdress.Clear();
            lstAdress.Add("PA-2_READY");
            arrTagAdress = lstAdress.ToArray<string>();
            readTags();
            if (get_value("PA-2_READY") == "0")
            {
                btnLightCoil.Text = "光卷入库：关闭";
                btnLightCoil.BackColor = Color.Yellow;
            }
            else if (get_value("PA-2_READY") == "1")
            {
                btnLightCoil.Text = "光卷入库：打开";
                btnLightCoil.BackColor = Color.LightGreen;
            }
