...
{
    public partial class PREMIERE_TESTING_Z42_BAY : FormBase
    {
        public PREMIERE_TESTING_Z42_BAY()
        {
            InitializeComponent();
        }
        ...
        private string bayNO = "Z42";

        private string craneNO_1 = "4_3";
        private string craneNO_2 = "4_4";
        private string craneNO_3 = "4_5";
