...
namespace UACSView
{
    public partial class VIEW_D112ExitLineSaddle : FormBase
    {
        private Baosight.iSuperframe.Authorization.Interface.IAuthorization auth;
        public VIEW_D112ExitLineSaddle()
        {
            InitializeComponent();
            //反射获取双缓存
            ...
            this.Load += VIEW_D112ExitLineSaddle_Load;
        }
        ...
        void VIEW_D112ExitLineSaddle_Load(object sender, EventArgs e)
        {
            auth = FrameContext.Instance.GetPlugin<IAuthorization>() as IAuthorization;
            tagDataProvider.ServiceName = "iplature";
            //绑定鞍座控件
            dicSaddleControls["D112WC0010"] = coilUnitSaddle10;
            dicSaddleControls["D112WC0009"] = coilUnitSaddle9;
            dicSaddleControls["D112WC0008"] = coilUnitSaddle8;
            dicSaddleControls["D112WC0007"] = coilUnitSaddle7;
            dicSaddleControls["D112WC0006"] = coilUnitSaddle6;
            dicSaddleControls["D112WC0005"] = coilUnitSaddle5;
            dicSaddleControls["D112WC0004"] = coilUnitSaddle4;
            dicSaddleControls["D112WC0003"] = coilUnitSaddle3;

            //coilUnitStatus1.InitTagDataProvide(constData.tagServiceName);
            //coilUnitStatus1.MyStatusTagName = AREA_SAFE_EXIT_D102;

            //实例化机组鞍座处理类
            saddleMethod = new UnitSaddleMethod(constData.UnitNo_8,constData.ExitSaddleDefine,constData.tagServiceName);
            saddleMethod.ReadDefintion();
            
            lineSaddleTag.InitTagDataProvider(constData.tagServiceName);


            coilUnitSaddleButton3.MySaddleNo = "D112WC0003";
            coilUnitSaddleButton4.MySaddleNo = "D112WC0004";
            coilUnitSaddleButton5.MySaddleNo = "D112WC0005";
            coilUnitSaddleButton6.MySaddleNo = "D112WC0006";
            coilUnitSaddleButton7.MySaddleNo = "D112WC0007";
            coilUnitSaddleButton8.MySaddleNo = "D112WC0008";
            coilUnitSaddleButton9.MySaddleNo = "D112WC0009";
            coilUnitSaddleButton10.MySaddleNo = "D112WC0010";
            ...
            GetLightCoilFlag();
            exitSaddleInfo.getExitSaddleDt(dgvExitSaddleInfo,constData.UnitNo_8);
        ...
        private void btn_Coil_Down_Click(object sender, EventArgs e)
        {
            ...
            string Unit_NO = constData.UnitNo_8;
