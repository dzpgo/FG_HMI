...
{
    public partial class PREMIERE_TESTING_Z41_BAY : FormBase
    {
        public PREMIERE_TESTING_Z41_BAY()
        {
            InitializeComponent();
        }
        ...
        private long baySpaceX = 234000;
        private long baySpaceY = 21000;
        private int panelWidth;
        private int panelHeight;
        private bool xAxisRight = true;
        private bool yAxisDown = false;
        private string bayNO = "Z41";

        private string craneNO_1 = "4_1";
        private string craneNO_2 = "4_2";
        private string craneNO_3 = "";
        ...
        private void timer_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach(ConCraneStatusPanel conCraneStatusPanel in lstConCraneStatusPanel)
                {
                        ...
                        conCraneStatusPanel.BeginInvoke(ConCraneStatusPanel_Invoke, new Object[] { cranePLCStatusInBay.DicCranePLCStatusBase[conCraneStatusPanel.CraneNO].Clone(), bayNO });
                }
