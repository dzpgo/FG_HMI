    ...
    public partial class ParkLaserOut : UserControl
    {
        ...
        public void DrawParksize(int x, int y, int xLength, int yLength,string carHearDrection)
        {
            try
            {
                ...
                g.DrawRectangle(myPen, n1 + YOffset1, n2 + XOffset1, n4, n3);       //调用Graphics对象的DrawRectangle方法
                if (carHearDrection == "W" || carHearDrection == "S")
                {
                    g.DrawString("车头:南（1—1门方向）", new Font("宋本", 10, FontStyle.Regular), new SolidBrush(Color.Black), pan1.Size.Width - 20, pan1.Size.Height / 5, new StringFormat(StringFormatFlags.DirectionVertical));               //绘制说明文字
                    //g.DrawString("北（6—7门）", new Font("宋本", 10, FontStyle.Regular), new SolidBrush(Color.Black), 0, pan1.Size.Height / 4, new StringFormat(StringFormatFlags.DirectionVertical));                    
                }
                else if ((carHearDrection == "E" || carHearDrection == "N"))
                {
                    g.DrawString("车头:北（1—2门方向）", new Font("宋本", 10, FontStyle.Regular), new SolidBrush(Color.Black), 0, pan1.Size.Height / 5, new StringFormat(StringFormatFlags.DirectionVertical));                  
                    //g.DrawString("南（6—1门）", new Font("宋本", 10, FontStyle.Regular), new SolidBrush(Color.Black), pan1.Size.Width - 20, pan1.Size.Height / 4, new StringFormat(StringFormatFlags.DirectionVertical));
                }
                //else
                //{
                //    g.Clear(Color.LightSteelBlue);
        ...
        public void DrawParksize(int x, int y, int xLength, int yLength, string carHearDrection, string YDrection)
        {
            try
            {
                //bitM.Dispose();
                ...
                {
                    g.DrawString("车头:北（4—3门方向）", new Font("宋本", 10, FontStyle.Regular), new SolidBrush(Color.Black), pan1.Size.Width - 20, pan1.Size.Height / 5, new StringFormat(StringFormatFlags.DirectionVertical));               //绘制说明文字
                    //g.DrawString("南（6—1门）", new Font("宋本", 10, FontStyle.Regular), new SolidBrush(Color.Black), 0, pan1.Size.Height / 4, new StringFormat(StringFormatFlags.DirectionVertical));
                }
                else if ((carHearDrection == "E" || carHearDrection == "S"))
                {
                    g.DrawString("车头:南（4—2门方向）", new Font("宋本", 10, FontStyle.Regular), new SolidBrush(Color.Black), 0, pan1.Size.Height / 5, new StringFormat(StringFormatFlags.DirectionVertical));
                    //g.DrawString("北（6—7门）", new Font("宋本", 10, FontStyle.Regular), new SolidBrush(Color.Black), pan1.Size.Width - 20, pan1.Size.Height / 4, new StringFormat(StringFormatFlags.DirectionVertical));
                }
                //else
                //{
                //    g.Clear(Color.LightSteelBlue);
                //    g.DrawRectangle(myPen, n1 + YOffset1, n2 + XOffset1, n4, n3);       //调用Graphics对象的DrawRectangle方法
                //    this.pan1.BackgroundImage = bitM;
                //}
                this.pan1.BackgroundImage = bitM;                //将画布设为panel1控件的背景图
            }
            catch (Exception)
